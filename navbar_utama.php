...
<nav class="navbar navbar-primary bg-primary fixed-top">
  <div class="container-fluid">
    <a class="navbar-brand text-light" href="#"><?php include "judul.php"; ?></a>
    ...
    <div class="offcanvas offcanvas-end text-bg-primary" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
      ...
      <div class="offcanvas-body text-light">
        ...
        <?php if(!isset($_SESSION['idUser'])) {?>
          ...
          <br> -->
          <li class="nav-item border text-center">
            <a class="nav-link text-light" href="user/transaksi_tiket.php?id=<?php echo $_SESSION['idUser']; ?>"><i class="bi bi-ticket-perforated-fill"></i> Tiket</a>
          </li> 
          <br>
          <li class="nav-item border text-center">
            <a class="nav-link active text-light" aria-current="page" href="user/edit.php?id=<?php echo $_SESSION['idUser']; ?>"><i class="bi bi-person-fill-gear"></i> Edit Akun</a>
          </li>
          <br>
